                    ...
                    <div className="content-container">
                        <div className="log-in-container">
                            ...
                            <form action="https://codepen.io/jasonrhoads1/pen/wvQKMpy">
                                ...
                                <CustomInputFields type="text" placeholder=" username, or email" value={fields.userName} onChange={(e) => validateInput("userName", e.target.value, 40, ERROR_MESSAGES, setErrorFields)} ></CustomInputFields>
